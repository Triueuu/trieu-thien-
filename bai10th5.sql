...
-- Lap 8 -- 
-- CÂU 1 -- 
CREATE PROCEDURE sp_THENHANVIEN
    @manv VARCHAR(5),
    @tennv NVARCHAR(50),
    @gioitinh NVARCHAR(10),
    @diachi NVARCHAR(100),
...
BEGIN
    ...
    RETURN 0;
END
EXEC sp_THENHANVIEN 'NV05', 'Nguyễn Thị ThaỎ', 'Nữ', 'Hà Nam', '0982626523', 'thao@gmail.com', 'Kinh doanh',0
...
EXEC ThemMoiSanPham 'SP08',N'Samsung','A72','200000','ĐEN THUI','8000000',N'Chiếc',N'Hàng trung cấp',1
...
BEGIN
    ...
    END
        ...
        END
END
EXEC sp_ThemHangsx1 'H04','APPLE',N'MỸ','911',N'AP@gmail.com'
...
-- cau 2 -- 
RESTORE DATABASE [Quanlibanhang] FROM DISK = 'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Quanlibanhang.bak' WITH standby 
RESTORE DATABASE [Quanlibanhang] FROM DISK = 'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Quanlibanhang.bak' WITH standby 
RESTORE LOG [Quanlibanhang] FROM DISK = 'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Quanlibanhang.bak' 